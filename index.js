(() => {
  ...
  var MainMenuScene = class extends GameScene {
    scene = this.setup();
    getScene() {
      return this.scene;
    }
    ...
    setup() {
      ...
      scene.background = new Color(4473924);
      const floorGeometry = new PlaneGeometry(4, 4);
      const floorMaterial = new MeshStandardMaterial({ color: 16711833 });
      const floor = new Mesh(floorGeometry, floorMaterial);
      floor.rotation.x = -Math.PI / 2;
      floor.receiveShadow = true;
      scene.add(floor);
      scene.add(new HemisphereLight(12369084, 10855845, 3));
